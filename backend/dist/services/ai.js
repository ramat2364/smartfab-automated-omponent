...
class AiService {
     ...
     */
    static async callClaude(prompt, systemPrompt, serviceName, mockResponseGenerator) {
            ...
            try {
                const response = await fetch('https://api.anthropic.com/v1/messages', {
                    ...
                    headers: {
                        ...
                        'x-api-key': config_1.config.anthropicApiKey,
        ...
        await db_1.default.aiCallLog.create({
            data: {
                serviceName,
     ...
     */
    static async generatePredictiveMaintenance(machineCode, type, currentReadings, activeAlerts) {
...
*Report generated automatically by SmartFab Digital Platform AI Assistant.*`;
     ...
     */
    static async suggestQualityRootCause(defectDescription, partNumber, machineCode) {
